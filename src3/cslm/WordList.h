 ...
 *
 * $Id: WordList.h,v 1.6 2014/03/25 21:52:53 schwenk Exp $
 */
...
public:
   ...
   */
  WordIndex Read(const char *fname, WordIndex slist_len = -1);
   ...
   */
  void CountWords(int &sum_slist, int &sum_total) const;
   ...
   */
  inline WordInfo& GetWordInfo(WordIndex index) {
