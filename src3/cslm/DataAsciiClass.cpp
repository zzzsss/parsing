 ...
 *
 * $Id: DataAsciiClass.cpp,v 1.6 2014/03/25 21:52:53 schwenk Exp $
 */
...
DataAsciiClass::DataAsciiClass(char *p_prefix, ifstream &ifs, DataAsciiClass *prev_df) : DataAscii::DataAscii(p_prefix, ifs, prev_df)
{
