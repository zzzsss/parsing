 ...
 *
 * $Id: DataMnist.cpp,v 1.8 2014/03/25 21:52:53 schwenk Exp $
 */
...
DataMnist::DataMnist(char *p_prefix, ifstream &ifs, DataMnist *prev_df) : DataFile::DataFile(p_prefix, ifs, prev_df)
{
